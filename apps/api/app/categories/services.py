...
async def get_categories_paginated_service(db: SessionDep, offset: int = 0, limit: int = 4) -> CategoryPaginated:
    """
...
def build_pagination_metadata(content: List[Category], total_items: int, offset: int, limit: int) -> CategoryPaginated:
